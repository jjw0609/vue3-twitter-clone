          ...
          <div class="flex flex-col">
            ...
            <div class="flex px-3 py-3 border-b-8 border-gray-100">
              ...
              <div class="ml-2 flex-1 flex flex-col">
                <textarea placeholder="무슨 일이 일어나고 있나요?" class="w-full text-lg font-bold focus:outline-none mb-3 resize-none bg-gray-100"></textarea>
            ...
            <div class="flex px-3 py-3 border-b border-gray-100" v-for="tweet in 10" :key="tweet">
              ...
              <div class="ml-3 flex-1 flex flex-col space-y-1">
                <div class="text-sm space-x-1">
                  <span class="font-bold">정재웅</span>
                  <span class="text-gray-500 text-xs">@jjw</span>
                  <span>•</span>
                ...
                <div class="flex justify-between">
                  <div class="text-gray-500 hover:text-primary">
                    ...
                    <span class="ml-1 text-gray-500 text-sm">1</span>
                  </div>
                  <div class="text-gray-500 hover:text-green-500">
                    <i class="fa fa-retweet hover:bg-green-50 rounded-full p-2"></i>
                    <span class="ml-1 text-gray-500 text-sm">1</span>
                  </div>
        ...
        <div class="hidden lg:block lg:w-2/5 px-4 py-2">
          ...
          <div class="w-full rounded-lg bg-gray-50 flex flex-col">
            ...
            <div class="border-b border-gray-100 hover:bg-gray-100 px-4 py-2 cursor-pointer" v-for="trend in 3" :key="trend">
              <div class="flex">
                <div class="flex-1 flex flex-col">
                  ...
                  <div class="font-bold text-lg">하하하</div>
            ...
            <div class="px-4 py-2 hover:bg-gray-100">
              <span class="text-primary text-lg px-4 py-2 rounded-xl">더 보기</span>
            </div>
          </div>
