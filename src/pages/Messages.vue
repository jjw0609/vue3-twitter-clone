        ...
        <div class="flex px-3 py-4 hover:bg-gray-50 border-b border-gray-100 bg-gray-200">
          ...
          <div>
            <div class="flex space-x-1">
              <div class="font-bold">jjw.com</div>
              <div class="text-gray-500">@jaewoong</div>
              <div class="text-gray-500">9월 17일</div>
            </div>
    ...
    <div class="w-3/5 border-r border-gray-100">
      <div class="flex flex-col h-screen">
        ...
        <div class="flex items-center bg-white border-t border-gray-100 sticky">
          <input type="text" class="m-2 py-1 px-4 rounded-full bg-gray-100 resize-none outline-none flex-1" placeholder="새 쪽지 작성하기" rows="1" />
