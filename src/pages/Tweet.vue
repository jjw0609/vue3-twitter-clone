      ...
      <div class="flex flex-col">
        ...
        <div class="px-3 py-2 flex">
          ...
          <div class="ml-2">
            ...
            <div class="text-gray text-sm">@jjw</div>
          </div>
        </div>
        <div class="px-3 py-2">가나다라마바사아자차카타파하</div>
        <div class="px-3 py-2 text-gray text-xs">오후 7:00 · 2023년 10월 22일</div>
        ...
        <div v-for="comment in 10" :key="comment" class="flex hover:bg-gray-100 cursor-pointer px-3 py-3 border-b border-gray-100">
          ...
          <div class="ml-2 flex-1">
            <div class="flex items-center space-x-2">
              <span class="font-bold">jjw@jjw.com</span>
          ...
          <button>
            <i class="fas fa-trash text-red-400 hover:bg-red-50 w-10 h-10 rouned-full p-2"></i>
          </button>
        </div>
      </div>
    </div>
